    ...
    <div className="flex h-[100%] flex-col justify-between">
      <Tabs>
        ...
        >
          <Link
            href="/product-types"
            className={`group flex items-center space-x-4 ${usePathname() === "/product-types" ? "text-white" : ""}`}
            title="product types"
          >
            <svg
              width="41"
            ...
            {isMenuExpanded && (
              <span
                className={`inline-block ${
                  usePathname() === "/product-types" ? "text-white" : "text-black group-hover:text-white"
                }`}
              >
                Product Types
              </span>
        ...
        >
          ...
          >
            ...
            >
              <path
                className={`transition-all duration-300 ${
                  usePathname() === "/retailers" ? "fill-white" : "fill-black group-hover:fill-white"
                }`}
            ...
            {isMenuExpanded && (
              <span
                className={`inline-block ${
                  usePathname() === "/retailers" ? "text-white" : "text-black group-hover:text-white"
                }`}
              >
                Retailers
              </span>
        ...
        >
          <Link
            href="/batch"
            className={`group flex items-center space-x-4 ${usePathname() === "/batch" ? "text-white" : ""}`}
            title="batch"
          >
            <svg
              width="41"
            ...
            >
              <path
                className={`transition-all duration-300 ${
                  usePathname() === "/batch" ? "stroke-white" : "stroke-black group-hover:stroke-white"
                }`}
            ...
            {isMenuExpanded && (
              <span
                className={`inline-block ${
                  usePathname() === "/batch" ? "text-white" : "text-black group-hover:text-white"
                }`}
              >
                Batch
              </span>
        ...
        >
          <Link
            href="/company-sales"
            className={`group flex items-center space-x-4 ${usePathname() === "/company-sales" ? "text-white" : ""}`}
            title="company-sales"
          >
            <svg
              width="40"
            ...
            {isMenuExpanded && (
              <span
                className={`inline-block ${
                  usePathname() === "/company-sales" ? "text-white" : "text-black group-hover:text-white"
                }`}
              >
                Company Sales
              </span>
        ...
        >
          <Link
            href="/retailer-sales"
            className={`group flex items-center space-x-4 ${usePathname() === "/retailer-sales" ? "text-white" : ""}`}
          ...
          >
            ...
            >
              <path
                className={`transition-all duration-300 ${
                  usePathname() === "/retailer-sales" ? "fill-white" : "fill-black group-hover:fill-white"
                }`}
            ...
            {isMenuExpanded && (
              <span
                className={`inline-block ${
                  usePathname() === "/retailer-sales" ? "text-white" : "text-black group-hover:text-white"
                }`}
              >
                Retailer Sales
              </span>
