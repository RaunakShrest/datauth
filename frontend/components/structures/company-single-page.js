...
export default function CompanySinglePage({ params }) {
  const router = useRouter()

  return (
    <div className="space-y-6">
      <h2 className="text-center text-3xl font-bold text-[#3f3f3f]">Apple</h2>
      ...
      <div className="flex justify-between">
        <Button
          ...
          onClick={() => router.push(`/companies/single-company/edit`)}
        >
          Edit Profile
        </Button>
