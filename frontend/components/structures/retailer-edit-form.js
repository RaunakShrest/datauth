...
import { useSingleRetailerEdit } from "@/contexts/edit-single-retailer-form"

export default function EditRetailerForm() {
  const { handleSubmit, register, watch, errors } = useSingleRetailerEdit()
        ...
        <div className="space-y-6 rounded-md border-2 border-gray-200 bg-white p-6">
          <div
            className={twMerge(
              ...
              errors && errors["retailerStatus"] ? "border-red-600" : "",
            )}
          >
            <RadioGroup
