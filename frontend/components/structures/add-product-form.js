    ...
    <div className="space-y-6">
      <div className="space-y-10 rounded-md border-2 border-gray-200 bg-white p-6">
        ...
        <input
          ...
          className="mt-1 block w-full rounded-md border border-gray-300 shadow-sm focus:outline-none focus:ring focus:ring-opacity-50"
        />
        ...
        <div className="mt-4">
          ...
          <div className="mt-2 flex flex-wrap gap-4">
            {imagePreviews.map((image, index) => (
              <div
                key={index}
                className="relative h-32 w-32 overflow-hidden rounded border border-gray-300"
              >
                <img
                  src={image}
                  alt={`Preview ${index + 1}`}
